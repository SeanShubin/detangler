...
import com.seanshubin.detangler.modle.{Detangled, Module, Single}
...
object SampleData {
  ...
  val detangled = new Detangled {
    override def root(): Module = moduleRoot

    override def children(module: Module): ParSet[Module] = map(module).children
  }
